...
async def get_member_last_msg(ctx, member) -> discord.Message:
    latest_msg = None

    for channel in ctx.guild.text_channels:
        try:
            # To compromise between functionality and performance, we only look back 200 messages in the current channel
