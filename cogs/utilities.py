...
class UtilitiesCog(commands.Cog):
    ...
    # TODO: should prevent this command from running if the author doesn't have access to the mentioned channel
    ...
    async def whois(self, ctx, *, member: discord.Member = None):
        ...
        try:
            member_latest_msg = await tools.get_member_last_msg(ctx, member)
    ...
    async def suggest(self, ctx, *, user_suggestion: str):
        ...
        suggest_channel = self.bot.get_channel(config.SUGGEST_CHANNEL_ID)
