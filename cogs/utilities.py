...
class UtilitiesCog(commands.Cog):
    ...
    # TODO: add section at bottom that summarizes what this bot is,
    #       its purpose, links to our website, YT channl and GitHub repo
    @commands.command(aliases=["botinfo", "info"])
    async def about(self, ctx):
        # Grab version number generated by GitHub release-please action
        with open("version.txt") as f:
            bot_version = f.readlines()
    ...
    async def changelog(self, ctx):
        # Grab version num previously generated by GitHub release-please action
        with open("version.txt") as f:
            bot_version = f.readlines()
